...
export default defineComponent({
  ...
  setup() {
    ...
    const appendNewRoute = () => {
      ...
      tabsRouterStore.appendTabRouterList({ path, title: title as string, name, isAlive: true, icon: icon as string });
    };
      ...
      return (
        ...
        <t-layout class={[`${prefix}-layout`]}>
          {isUseTabsRouter && (
            <t-tabs
              theme="card"
              class={`${prefix}-layout-tabs-nav frsimple-layout`}
              value={route.path}
                      ...
                      >
                        {!router.isHome ? (
                          <div style={{ display: 'flex', alignItems: 'center' }}>
                            <t-icon name={router.icon}></t-icon>
                            <span style={{ marginLeft: '3px' }}>{router.title}</span>
                          </div>
                        ) : (
                          <div style={{ display: 'flex', alignItems: 'center' }}>
